function [jointSpeed,error, w] = control_loop(trajectoryStep,poseActual, stepSize, clientID, object, functionCall, vrep, endEffectorVelocity, normalVector, forceReading, forceControl,torqueVector, maxSpeed, previousTrajectory)% posePrevious)
    %% Error Calculation
    %poseActual
    %trajectoryStep
